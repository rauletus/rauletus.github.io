...
Attention : Pour un signal PWM (rectangulaire) sur la voie, un mutimètre **True RMS** ou un oscilloscope est nécessaire pour avoir une mesure correcte du signal.